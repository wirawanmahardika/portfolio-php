  ...
  <div id="contact" class="bg-bgBlack flex flex-col w-full">
    <form class="flex flex-col items-center p-3 gap-y-3 text-white pt-10">
      ...
      <div class="flex flex-col w-4/5 sm:w-3/5 md:w-1/2">
        ...
        <input
          type="text"
          class="rounded px-2 py-0.5 bg-slate-900 font-medium outline-none focus:ring focus:ring-red-500 md:py-1"
      ...
      <button class="bg-red-600 hover:bg-red-800 px-5 py-1 font-semibold rounded text-black sm:px-6">
        SEND
      </button>
    </form>

    <p class="text-slate-50 text-center text-2xl font-bold p-2 mt-20 md:mt-14">Or you can contact me using these sosmed below</p>
