    ...
    <div class="w-full h-screen flex font-jost overflow-hidden">
        <div class="overflow-hidden bg-stone-900 w-1/6">
            <nav class="w-full flex flex-col text-gray-200">
                ...
                <span class="hover:text-sky-600 hover:bg-slate-800 bg-black border-y border-stone-700 p-1 flex justify-between px-2 items-center cursor-pointer">Skills</span>
                <div class="flex flex-col font-quicksand px-4 overflow-hidden ${height} py-1">
                ...
                <span class="hover:text-sky-600 hover:bg-slate-800 bg-black border-y border-stone-700 p-1 flex justify-between px-2 items-center cursor-pointer">Projects</span>
                <div class="flex flex-col font-quicksand px-4 overflow-hidden ${height} py-1">
